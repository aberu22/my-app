  ...
  return (
    <>
      ...
      >
        ...
        <NavItem icon={Icon.Folder} label="Account" href="/account" />
        ...
        <NavItem icon={Icon.Upload} label="Uploads" href="/uploads" />
        <NavItem icon={Icon.Trash} label="Trash" href="/trash" />
        <NavItem icon={Icon.PlusFolder} label="New folder" href="/folders/new" />
            ...
            <>
              ...
              {profileOpen && (
                ...
                >
                  ...
                  <button
                    onClick={() => { router.push('/upgrade'); setProfileOpen(false); }}
